...
async function roll() {
  let client = new MongoClient('mongodb+srv://vojtas42:ahojvsici7@cluster0.htqhgre.mongodb.net/ToDoApp?retryWrites=true&w=majority')
...
function passwordProtected(req, res, next) {
  ...
  if (req.headers.authorization == "Basic YmVyZHk6dm9qdGE=") {
    next()
  } else {
